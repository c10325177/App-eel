...
public class AdminPage extends JPanel{
	...
	private JButton manageAccounts = new JButton("Manage Accounts");
	private JButton search = new JButton("Search");
	private JButton libraryReports = new JButton("Library Reports");
	private JButton manageBooks = new JButton("Manage Books");
	private JButton logout = new JButton("Log Out");
	private JLabel key = new JLabel("test");
	...
	public AdminPage(){
		...
		logout.setForeground(Color.red);
		    ...
		    gbcMain.insets = new Insets(0,-30,-200,0);
		    gbcMain.gridx = 0;
		    gbcMain.gridwidth = 1;
		    ...
		    gbcMain.gridwidth = GridBagConstraints.REMAINDER;
		    gbcMain.insets = new Insets(0,-55, -200, 0);
